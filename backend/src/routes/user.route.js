...
router.patch('/id/:id', auth(), awaitHandlerFactory(userController.updateUser)); // localhost:3000/api/v1/users/id/1 , using patch for partial update
router.delete('/id/:id', auth(Role.Admin), awaitHandlerFactory(userController.deleteUser)); // localhost:3000/api/v1/users/id/1
router.get('/ranking', auth(), awaitHandlerFactory(userController.getRanking)); // localhost:3000/api/v1/users/ranking
